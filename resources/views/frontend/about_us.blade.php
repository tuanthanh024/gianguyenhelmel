...
@section('title')
    {{ mb_convert_case('về chúng tôi', MB_CASE_TITLE, 'UTF-8') }}
@endsection
@section('content')
    ...
    <div class="main-content-area">
        <div class="aboutus-info style-center">
            ...
            <p class="txt-content">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum
                has been the dummy text ever since the 1500s, when an unknown printer took a galley of type</p>
        </div>
        ...
        <div class="row equal-container">
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <div class="aboutus-box-score equal-elem ">
                    ...
                    <p class="desc">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum
                        has been the dummy text ever since the 1500s...</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <div class="aboutus-box-score equal-elem ">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <div class="aboutus-info style-small-left">
                    ...
                    <p class="txt-content">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots
            ...
            <div class="our-staff">
                <div class="slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-autoplay="true"
                    ...
                    <div class="team-member equal-elem">
                        <div class="media">
                            <a href="#" title="LEONA">
                                <figure><img src="{{ asset('frontend/images/member-leona.jpg') }}" alt="LEONA">
                                </figure>
                            </a>
                        </div>
                        <div class="info">
                    ...
                    <div class="team-member equal-elem">
                        <div class="media">
                            <a href="#" title="LUCIA">
                                <figure><img src="{{ asset('frontend/images/member-lucia.jpg') }}" alt="LUCIA">
                                </figure>
                            </a>
                        </div>
                        <div class="info">
                    ...
                    <div class="team-member equal-elem">
                        <div class="media">
                            <a href="#" title="NANA">
                                <figure><img src="{{ asset('frontend/images/member-nana.jpg') }}" alt="NANA">
                                </figure>
                            </a>
                        </div>
                        <div class="info">
                    ...
                    <div class="team-member equal-elem">
                        <div class="media">
                            <a href="#" title="BRAUM">
                                <figure><img src="{{ asset('frontend/images/member-braum.jpg') }}" alt="BRAUM">
                                </figure>
                            </a>
                        </div>
                        <div class="info">
